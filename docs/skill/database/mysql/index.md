...
-- 修改用户名与命名
UPDATE `user` SET `username`='Aaron',`password`='a12345678` WHERE id = 1
```
...
![img](https://img.Aaron.cn/20201009150524563.png)
...
SELECT LOWER('Aaron') --到小写
SELECT UPPER('Aaron') --到大写
```
...
![image-20210102213536190](https://img.Aaron.cn/image-20210102213536190.png)
