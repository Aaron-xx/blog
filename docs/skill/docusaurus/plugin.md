...
这样你就能看到你的站点访客主要都在看哪些页面，以及行为记录，如下图所示。![image-20221204153015256](https://img.Aaron.cn/image-20221204153015256.png)
...
![image-20221204153401244](https://img.Aaron.cn/image-20221204153401244.png)
