...
# image: https://img.Aaron.cn/trpc-banner.png
toc_max_heading_level: 3
---

<!-- ![trpc-banner](https://img.Aaron.cn/trpc-banner.png) -->
...
在线体验地址：[TRPC demo](https://trpc.Aaron.cn/)
...
![image-20230308142331808](https://img.Aaron.cn/image-20230308142331808.png)
...
![image-20230308142452678](https://img.Aaron.cn/image-20230308142452678.png)
...
![](https://img.Aaron.cn/image_YDKc7TixQA.png)
...
![](https://img.Aaron.cn/image_WfW8ehqUKz.png)

![](https://img.Aaron.cn/image_qicvoGjshx.png)
...
调用 `trpc.greeting.useQuery({ name: 'Aaron' })` 发送的请求的 query 参数则变为

![](https://img.Aaron.cn/20230307214659.png)

不仅于此，你如果同时调用了多次 greeting 函数，如

```typescript title='pages/index.tsx'
const result1 = trpc.greeting.useQuery({ name: 'Aaron1' })
const result2 = trpc.greeting.useQuery({ name: 'Aaron2' })
const result3 = trpc.greeting.useQuery({ name: 'Aaron3' })
```

tRPC 会将这三次函数调用合并成一次 http 请求，并且得到的响应本文也是以多条数据的形式返回

![](https://img.Aaron.cn/image_ufrhaugaIj.png)

![](https://img.Aaron.cn/image_cvlDJjhwPl.png)

分别输出三者 result 也没有任何问题。

![](https://img.Aaron.cn/image_hbL8So_RzB.png)
...
![](https://img.Aaron.cn/image_-qEI8jR1uM.png)

![](https://img.Aaron.cn/image_RTdWJn_55p.png)
...
![](https://img.Aaron.cn/image_8BUcBPK8In.png)
...
![](https://img.Aaron.cn/image_ERGzEt2Tq8.png)
...
![](https://img.Aaron.cn/image_QBXnHdoewh.png)
...
![](https://img.Aaron.cn/image__B1RYeiFze.png)
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        const user = { id: '1', name: 'Aaron', email: 'hi@Aaron.cn' }
...
![](https://img.Aaron.cn/image_9eowvvnwU2.png)
...
![](https://img.Aaron.cn/image_7_XKmbuK87.png)
...
这里我提供了一个简单的示例，你可以 [点我](https://trpc.Aaron.cn) 访问体验一下（项目部署在 Vercel，而数据库服务在腾讯云，登录服务又依赖 Github，所以项目会稍微有那么慢）。整个项目结构大致如下

![](https://img.Aaron.cn/image_z_YaR-RnSu.png)
