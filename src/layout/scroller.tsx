...
import { FCWC } from '@site/src/types';
import { ScrollDistance } from '../links/blog/types';
import { LeftButton, RightButton } from './scrollbtns';

export const ScrollContainer: FCWC<{ parent: HTMLDivElement | null }> = ({ children, parent }) => {
