...
import { useRandomIntFrom } from '@site/src/hooks/useRandomInt';
...
export const BlogThumb: FC<Props> = (props) => {
    ...
    useEffect(() => {
        ...
        if (isNil(image)) setImage(bgImages[useRandomIntFrom(0, 6)]);
    }, [image, postType]);
    useEffect(() => {
        if (postType === 'image') return;
        if (isNil(metaIcon)) {
            setBgPostion(useRandomIntFrom(0, 6) * -40);
            return;
        }
        ...
        >
            ...
            <div className={styles.wrapper}>
                ...
                <header>
                    ...
                    {tagsExists && postType !== 'image' && <Tags data={tags} />}
